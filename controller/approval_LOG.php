<?php
    ...
    if($_SESSION['role'] == "Approver"){
        ...
        if (mysqli_query($conn, $approve_sql)) {
            ...
            ///Notify via email
            $to         =   $logistic_email;
            $subject    =   "TESTING E-NCMR Form No ".$ncmr_no." has been Submitted.";
            $txt        =   "Hi, ".$logistic_usr."\n\n"
                            . "Good day. The TESTING NCMR Form no : ".$ncmr_no." has been Successfully Submitted."
            ...
            $txt2       =   "Hi, ".$safety_usr."\n\n"
                            . "Good day. The TESTING NCMR Form no : ".$ncmr_no." has been Approved by ".$logistic_usr."."
            ...
            $subject3   =   "TESTING E-NCMR Form No ".$ncmr_no." is waiting for your Approval.";
            $txt3       =   "Hi, ".$issued_name."\n\n"
                            . "Good day. The TESTING NCMR Form no : ".$ncmr_no." has been Approved by ".$logistic_usr."."
                            ."\n" . "This form is waiting for your Approval to proceed further."
                            . "\n" . "To check the form, please visit the E-NCMR System at http://192.168.1.235:8088/ncmr_test."
