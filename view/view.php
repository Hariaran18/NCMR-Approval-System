      ...
      <hr width = 80%>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="number" class="form-control" id="nc_qty" name="nc_qty" value="<?php echo $nc_qty; ?>" readonly>
              ...
              <td class="col">
                <?php
                  if ($img_2 == "" && $issued_name == $_SESSION["name"]) { ?>
                    ...
                    <form action="../controller/rework_photo.php" method="post" enctype="multipart/form-data">
        ...
        <div class="container row gy-5">
          ...
          <div class="p-3 border bg-light form-group col-md-4 card">
            ...
            <textarea class="form-control" id="comments4" name="comments4" readonly><?php echo $comments4; ?></textarea>
          </div>
          <div class="p-3 border bg-light form-group col-md-4 card">
            ...
            <?php } ?>
            <label class="font-weight-bold">Comments</label>
            <textarea class="form-control" id="comments5" name="comments5" readonly><?php echo $comments5; ?></textarea>
          </div>
        </div>
        <br>
        <br>
        ...
        <div class="container" id="write_off_form" style="display:none;">
          ...
          <div class="row gy-5">
            <div class="p-3 border bg-light form-group col-md-4 card">
              ...
              <label class="font-weight-bold">Comments</label>
              <textarea class="form-control" id="comments1" name="comments1" readonly><?php echo $comments1; ?></textarea>
            </div>
            <div class="p-3 border bg-light form-group col-md-4 card">
              ...
              <label class="font-weight-bold">Comments</label>
              <textarea class="form-control" id="comments2" name="comments2" readonly><?php echo $comments2; ?></textarea>
            </div>
            <div class="p-3 border bg-light form-group col-md-4 card">
              ...
              <label class="font-weight-bold">Comments</label>
              <textarea class="form-control" id="comments3" name="comments3" readonly><?php echo $comments3; ?></textarea>
            </div>
          </div>
          <hr width = 80%>
          ...
          <div class="row gy-5">
            <div class="p-3 border bg-light form-group col-md-4 card">
              ...
              <input type="text" class="form-control" name="witnessed_by" id="witnessed_by" value="<?php echo $witnessed_by; ?>" readonly></input>
            ...
            <div class="p-3 border bg-light form-group col-md-4 card">
              ...
              <input type="text" class="form-control" name="disposed_by" id="disposed_by" value="<?php echo $disposed_by; ?>" readonly></input>
          ...
          <div class="row gy-5">
            <div class="p-3 border bg-light form-group col-md-4 card">
              ...
              <input type="text" class="form-control" name="finance_name" id="finance_name" value="<?php echo $finance_name; ?>" readonly></input>
