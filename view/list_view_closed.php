<?php
	...
	if($_SESSION["username"]) {
		...
		$query = "SELECT ncmr_no, issue_date, part_no, issued_date, issued_name, form_state FROM form WHERE form_state IN (98, 99) ORDER BY ncmr_no DESC";
...
<html>
	...
	<div class="container">
		...
		<h4 class="text-center">Application List (Closed)</h4>
      	<hr width = 80%>
			<div class="col-md-12">
				<div class="card">
